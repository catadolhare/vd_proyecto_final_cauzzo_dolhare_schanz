...
<main>
  ...
  <audio bind:this={audioEstateItaliana} src="canciones/estate_italiana.mp3"
  ></audio>
  ...
  <div class="intro">
    ...
    <div class="intro1">
      <p>
        Una comparativa de las tres seleccionas argentinas que se hicieron con
          ...
          <div class="alert-box">
            <div class="canciones">
              ...
              <div class="boton_cancion">
                <button
                  class="button_canciones"
                  on:click={() =>
                    playAudio(
                      audioWakawaka,
                      (playing) => (isPlayingWakawaka = playing)
                    )}
                >
                  {#if isPlayingWakawaka}
                    <img
                      src="images/pausa_violeta.png"
                      alt="Pause"
                      style="width:25px; height:25px;"
                    />
                  {:else}
                    <img
                      src="images/play_violeta.png"
                      alt="Play"
                      style="width:25px; height:25px;"
                    />
                  {/if}
              ...
              <div class="boton_cancion">
                <button
                  ...
                  on:click={() =>
                    playAudio(
                      audioEstateItaliana,
                      (playing) => (isPlayingEstateItaliana = playing)
                    )}
                >
              ...
              <div class="boton_cancion">
                <button
                  ...
                  on:click={() =>
                    playAudio(
                      audioWeareone,
                      (playing) => (isPlayingWeareone = playing)
                    )}
                >
              ...
              <div class="boton_cancion">
                <button
                  ...
                  on:click={() =>
                    playAudio(
                      audioLacopavida,
                      (playing) => (isPlayingLacopavida = playing)
                    )}
                >
      ...
      {#if showFloatingControl}
        <div class="floating-control">
          <button class="control-button" on:click={stopAllAudio}>
            {#if isPaused}
              <img
                src="images/play_blanco.png"
                alt="Play"
                style="width:20px; height:20px;"
              />
            {:else}
              <img
                src="images/pausa_blanco.png"
                alt="Pause"
                style="width:20px; height:20px;"
              />
            {/if}
  ...
  <div class="fondo_intro2">
    ...
    <div class="intro2">
      ...
      <div class="texto">
        ...
        <p>
          La Copa Mundial de la FIFA se ha convertido en el torneo deportivo más
          aclamado del mundo. Durante años ha sabido atrapar a conocedores y a
          aficionados, ofreciendo una mezcla única de emoción, pasión y talento.
          Desde su inicio en 1930, y más allá de las modificaciones que
          presentó, el Mundial ha sido el escenario de muchos de los momentos
          más icónicos del fútbol, donde equipos de todas las naciones compiten
          por la gloria.
        </p>
      </div>
    </div>
    ...
    <div class="paises">
      <div class="grafico_paises">
        <iframe
          title="Mundial 1978"
          aria-label="Map"
          id="datawrapper-chart-oL8XV"
          src="https://datawrapper.dwcdn.net/oL8XV/2/"
          scrolling="no"
          frameborder="0"
          style="border: none;"
          width="600"
      ...
      <div class="info-mundial">
        <div class="texto-paises">
          <h3>1978</h3>
          <p>
            , contó con la participación de 16 países. Este torneo fue notable
            por la gran competencia y el ambiente festivo que se vivió.
            Argentina se coronó campeona del mundo por primera vez en su
            historia, tras vencer a Países Bajos en el Monumental.
          </p>
        </div>
    ...
    <div class="paises">
      <div class="info-mundial">
        <div class="texto-paises">
          <h3>1986</h3>
          <p>
            , celebrado en México, reunió a 24 equipos de diversas partes del
            mundo. Este torneo es recordado por las actuaciones estelares de
            Diego Maradona, incluyendo su famoso "Gol del Siglo" y la "Mano de
            Dios". Argentina venció a Alemania y se consgró campeona nuevamente.
          </p>
        </div>
      ...
      <div class="grafico_paises">
        <iframe
          title="Mundial 1986"
          aria-label="Map"
          id="datawrapper-chart-BWQLZ"
          src="https://datawrapper.dwcdn.net/BWQLZ/6/"
          scrolling="no"
          frameborder="0"
          style="border: none;"
          width="600"
    ...
    <div class="paises">
      <div class="grafico_paises">
        <iframe
          title="Mundial 2022"
          aria-label="Mapa"
          id="datawrapper-chart-4ppPT"
          src="https://datawrapper.dwcdn.net/4ppPT/2/"
          scrolling="no"
          frameborder="0"
          style="border: none;"
          width="600"
      ...
      <div class="info-mundial">
        <div class="texto-paises">
          <h3>2022</h3>
          <p>
            , organizado en Qatar, el primer torneo mundialista realizado en el
            Medio Oriente y durante los meses de noviembre y diciembre, con 32
            selecciones, notable por sus innovaciones tecnológicas y su enfoque
            en la sostenibilidad. Argentina se coronó campeona por tercera vez,
            venciendo a Francia en una final épica.
          </p>
        </div>
      ...
      >
        ...
        <div slot="foreground" class="foreground_container">
          <section class="step_foreground">
            <div class="info-año">
              <p>
                César Luis Menotti convocó a 22 jugadores para el Mundial de
                1978, haciendo una selección que combinaba experiencia y
                juventud. Su predilecto 4-3-3, combinado con el rendimiento del
                plantel fue la llave con la que Argentina abrió las puertas del
                campeonato.
              </p>
              ...
              <div class="equipo">
                {#each datos as jugador}
                  {#if jugador.anio === 1978}
                    <button
                      class="futbolista"
                      on:click={() => toggleInfoJ(jugador)}
                    >
                      <img
                        src={getImagePath(jugador)}
                        alt={jugador.nombre}
                    ...
                    <div class="info">
                      {#if selectedJugador.anio === 1978}
                        <div class="foto_futbol">
                          <img
                            src={getImagePath(selectedJugador)}
                        ...
                        <div class="caracteristica_jugador">
                          ...
                          <p style="color:white; font-size:12px;">
                            Posición: {selectedJugador.posicion}
                          </p>
                          <p style="color:white; font-size:12px;">
                            Club: {selectedJugador.club}
                          </p>
                          <p style="color:white; font-size:12px;">
                            País club: {selectedJugador.pais_club}
                          </p>
                        </div>
                      {/if}
                      <button class="button_info_futb" on:click={toggleInfoJ}
                        ><img
                          src="images/cruz_blanca.png"
                          alt="cerrar"
                        /></button
                      >
                    </div>
      ...
      >
        ...
        <div slot="foreground" class="foreground_container">
          <section class="step_foreground">
            <div class="info-año">
              <p>
                Los 22 elegidos de Carlos Salvador Bilardo para el mundial 1986
                reflejaron su meticulosa y estratégica visión del fútbol. Apostó
                por un plantel que combinaba talento, disciplina y una fuerte
                mentalidad competitiva. Esta selección, aunque inicialmente
                cuestionada por algunos críticos, demostró ser perfecta para
                ejecutar su esquema táctico, llevando a Argentina a conquistar
                su segundo campeonato mundial.
              </p>
              <img src="images/tipito1986.png" alt="" />
              <!--Esta hay que acomodar posicion-->
            </div>
          </section>
      ...
      >
        ...
        <div slot="foreground" class="foreground_container">
          <section class="step_foreground">
            <div class="info-año">
              <p>
                La Selección de Scaloni, también llamada "Scaloneta", para el
                Mundial de 2022 destacó por su diversidad y equilibrio. Lionel
                Scaloni seleccionó a 26 jugadores, combinando experiencia y
                juventud. Con un enfoque en la cohesión y el espíritu de equipo,
                Scaloni logró formar un grupo compacto y versátil.
              </p>
  ...
  <div class="analisis">
    <div class="titulo">
      <div class="info-titulo">
        ...
        <p>
          Para comprender cómo cada una de estas selecciones se hizo con la copa
          debemos conocer las estadísticas detalladas de su desempeño.
          Analizaremos los partidos jugados por cada jugador, los goles
          anotados, las posiciones en el campo, las ligas de las que venían y
          las tarjetas recibidas. Esto nos permitirá desglosar las estrategias
          de cada DT, revelando cómo cada entrenador maximizó el potencial de
          sus jugadores. A través de esta comparación, podremos identificar los
          elementos clave que llevaron a Argentina al éxito en los Mundiales de
          1978, 1986 y 2022, destacando las similitudes y diferencias en su
