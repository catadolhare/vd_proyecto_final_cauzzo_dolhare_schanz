...
<main>
    ...
    <div class="fondo_intro2">
        <div class="intro2">
            <img src="images/copa.png" alt="Copa del mundo" style='height: 500px'>
            <div class="texto">
    ...
    <div class="paises">
        ...
        <!--ACLARAR: WEST GERMANY/SCOTLAND, NORTH IRELAND EN 1986-->
    ...
    <div class="paises">
        ...
        <!--ACLARAR: WEST GERMANY/SCOTLAND 18986 Y 1978-->
